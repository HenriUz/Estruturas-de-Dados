...
/*
Descrição: função que cria uma estrutura da árvore-b.
...
/*
Descrição: função que cria uma nova raiz para a árvore-b informada.
...
/*
Descrição: função que cria a nova chave inicial e chama a procuraPaginaI, dependendo do resultado cria uma nova raiz.
...
/*
Descrição: função que insere todos os registros (matrícula) de um arquivo na árvore-b.
...
/*
Descrição: função que transfere uma chave de uma página irmã a direita para o pai, e uma chave do pai para a página irmã a esquerda.
...
/*
Descrição: função que busca iterativamente pela árvore-b a matrícula informada.
...
/*
Descrição: função que imprime a árvore-b, tentando reproduzir ela em pre-ordem.
